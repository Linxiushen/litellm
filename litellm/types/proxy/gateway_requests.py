...
GatewayRequestSnapshot = Mapping[GatewayRequestKey, GatewayRequestCounts]
...
class GatewayRequestActivityResponse(BaseModel):
    ...
    by_date: list[GatewayRequestDailyEntry] = Field(default_factory=list)
    by_route: list[GatewayRequestBreakdownEntry] = Field(default_factory=list)
